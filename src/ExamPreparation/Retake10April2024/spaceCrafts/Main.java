...
//Get Spacecraft By Mission Type
        ...
        kennedySC.getSpacecraftsByMissionType("Orbiter1").forEach(spacecraft -> System.out.println(spacecraft.getName()));
        System.out.println(kennedySC.getSpacecraft("Cassini-Huygens"));
        System.out.println(kennedySC.getSpacecraft("Voyager-1"));
...
//Remove Spacecraft
        ...
        System.out.println(capeCanaveralAFS.removeSpacecraft("Voyager-1")); //false

        System.out.println(kennedySC.getCount()); //3
